...
<body>
	<form:form id="inputForm" modelAttribute="supplier" action="${ctx}/oa/supplier/${not empty fromModal?'ajaxSave':'save'}" method="post" class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<form:input path="contact" htmlEscape="false" maxlength="100" class="input-xlarge form-control required"/>
				<font color="red">*</font>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-4">
				<form:input path="phone" htmlEscape="false" maxlength="100" class="input-xlarge form-control required"/>
				<font color="red">*</font>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-md-4">
				<form:input path="qqWebChat" htmlEscape="false" maxlength="100" class="input-xlarge form-control "/>
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-2 control-label">邮箱：</label>
			<div class="col-md-4">
				<form:input path="email" htmlEscape="false" maxlength="100" class="input-xlarge form-control "/>
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-2 control-label">帐户名称：</label>
			<div class="col-md-4">
				<form:input path="blankAccountName" htmlEscape="false" maxlength="100" class="input-xlarge form-control "/>
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-2 control-label">开户行：</label>
			<div class="col-md-4">
				<form:input path="blankName" htmlEscape="false" maxlength="100" class="input-xlarge form-control "/>
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-2 control-label">帐号：</label>
			<div class="col-md-4">
				<form:input path="blankAccountNo" htmlEscape="false" maxlength="100" class="input-xlarge form-control "/>
			</div>
		</div>
		<div class="form-group">
