...
<form:form id="inputForm" modelAttribute="contract" action="${ctx}/oa/contract/save" method="post"
...
<div class="col-sm-12">
    <div class="card-box" name="card_info">
        <div class="pull-right">
            ...
            <a class="btn btn-custom waves-effect waves-light" data-toggle="modal" data-target="#con-close-modal"
               id="btnTest">选择框架合同</a>
        </div>
    ...
    <div class="card-box" id="card_other" name="card_other">
        <div class="pull-right">
            <a data-toggle="collapse" href="#other-collapse" class="collapsed" aria-expanded="true"><i
                    class="zmdi zmdi-minus"></i></a>
        </div>
    ...
    <div class="card-box" id="card_products">
        <div class="pull-right">
            <a data-toggle="collapse" href="#products-collapse" class="" aria-expanded="true"><i
                    class="zmdi zmdi-minus"></i></a>
        </div>
    ...
    <div class="form-actions">
        <shiro:hasPermission name="oa:contract:edit"><input id="btnSubmit" class="btn btn-custom" type="submit"
