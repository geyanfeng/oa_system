...
<body>
	...
	<form:form id="inputForm" modelAttribute="oaNotify" action="${ctx}/oa/oaNotify/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			<label class="col-md-2 control-label">类型<span class="help-inline"><font color="red">*</font> </span></label>
			<div class="col-md-4">
		...
		<div class="form-group">
			<label class="col-md-2 control-label">标题<span class="help-inline"><font color="red">*</font> </span></label>
			<div class="col-md-4">
		...
		<div class="form-group">
			<label class="col-md-2 control-label">内容<span class="help-inline"><font color="red">*</font> </span></label>
			<div class="col-md-4">
		...
		<c:if test="${oaNotify.status ne '1'}">
			...
			<div class="form-group">
				<label class="col-md-2 control-label">接受人<span class="help-inline"><font color="red">*</font> </span></label>
				<div class="col-md-4">
		...
		<c:if test="${oaNotify.status eq '1'}">
			...
			<div class="form-group">
				<label class="col-md-2 control-label">接受人：</label>
				<div class="col-md-4">
