...
<body>
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			<label class="col-md-2 control-label">机构名称<span class="help-inline"><font color="red">*</font> </span></label>
			<div class="col-md-4">
		...
		<div class="form-group">
			<label class="col-md-2 control-label">主负责人</label>
			<div class="col-md-4">
		...
		<div class="form-group">
			<label class="col-md-2 control-label">副负责人</label>
			<div class="col-md-4">
		...
		<c:if test="${empty office.id}">
			<div class="form-group">
				<label class="col-md-2 control-label">快速添加下级部门</label>
				<div class="col-md-4">
		...
		<div class="form-actions text-center">
			<shiro:hasPermission name="sys:office:edit"><input id="btnSubmit" class="btn btn-custom" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
