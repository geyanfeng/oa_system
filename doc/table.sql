...
CREATE TABLE `oa_commission` (
  ...
  `SV` decimal(20,4) NOT NULL COMMENT '合同金额',
  `COG` decimal(20,4) NOT NULL COMMENT '合同采购成本',
  `CC` decimal(20,4) NOT NULL COMMENT '客户费用',
  `LC` decimal(20,4) NOT NULL COMMENT '物流费用',
  `BILLING_DATE` datetime NOT NULL COMMENT '开票日期',
  `PAY_DATE` datetime NOT NULL COMMENT '收款日期',
  `PCCDAY` int(5) signed NOT NULL COMMENT '账期天数',
  `PAYMENT` decimal(20,4) NOT NULL COMMENT '支付金额(所有产品组)',
  `RATE` decimal(20,10) NOT NULL COMMENT '产品组占比支付百分比',
  `K_SALER_ID` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT ' 销售人员ID',
  `K_ID` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT ' 销售人员ID',
  `K_NAME` varchar(255) NOT NULL COMMENT ' 产品组名称',
  `K_SV` decimal(20,4) NOT NULL COMMENT '付款金额',
  `K_COG` decimal(20,4) NOT NULL COMMENT '采购成本',
  `K_CC` decimal(20,4) NOT NULL COMMENT '客户费用',
  `K_LC` decimal(20,4) NOT NULL COMMENT '物流费用',
  `K_GPI` decimal(20,4) NOT NULL COMMENT '毛利指标为GPI,本Q指标',
  `K_TR` decimal(20,4) NOT NULL COMMENT '税收点数TR',
  `K_AC` decimal(20,4) NOT NULL COMMENT 'AC调整系数AC 如净利（NP)<0，则调整系数 AC=1',
  `K_EC` decimal(20,4) NOT NULL COMMENT '激励系数EC 如净利（NP)<0，则激励系数 EC=1',
  `K_PCC` decimal(20,4) NOT NULL COMMENT '账期点数PCC',
  `K_GP` decimal(20,4) COMMENT '实际完成毛利为GP,本Q完成',
