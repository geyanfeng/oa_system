...
DROP EVENT IF EXISTS e_calcuate_customer_evaluate;
create event e_calcuate_customer_evaluate
...
DROP EVENT IF EXISTS e_quarter_setting;
create event e_quarter_setting
...
DROP EVENT IF EXISTS e_calcuate_allsalers_quarter_commission;
create event e_calcuate_allsalers_quarter_commission
